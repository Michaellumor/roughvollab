...
Monte Carlo cost is the target of the multilevel method of Giles~\cite{giles2008}, whose
efficiency is governed by three rates: the weak rate $\alpha$, the variance-decay rate
...
previously isolated. Antithetic multilevel estimation~\cite{gilesszpruch2014} and
