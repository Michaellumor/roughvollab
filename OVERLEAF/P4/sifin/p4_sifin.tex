...
% alongside for reference). The class loads amsmath/amssymb/graphicx/hyperref/
% ntheorem itself and predefines theorem/lemma/corollary/proposition/definition;
% remark is declared below via \newsiamremark. geometry removed (class layout).
