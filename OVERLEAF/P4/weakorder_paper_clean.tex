...
not been measured.
\reframe{Abstract novelty claim. Weak rates for rough-volatility schemes are established:
Gassiat 2023 (SIFIN), Bayer--Hall--Tempone 2023 (IJTAF), Friz--Salkeld--Wagenhofer 2025
(AAP), Bayer--Fukasawa--Nakahara 2022 (SIFIN), Bonesini--Jacquier--Pannier 2023. Reframe
as an empirical test in rough Heston against the rough-Bergomi theory.}
We ask whether roughness throttles the weak rate as it does the
...
\reframe{Same as above -- this sentence must go; replace with the positioning Michael
dictates.}
