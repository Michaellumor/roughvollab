...
\newcommand{\reframe}[1]{\medskip\noindent\textcolor{red}{[\,REFRAME: #1\,]}\medskip}
...
\normalsize Project advisor: \textsc{[ADVISOR NAME TBC]}\thanks{[Advisor affiliation TBC].}}
...
Tempone~\cite{bht2023} treat option pricing under linear rough volatility. None of these
...
% metadata to pin before submission
