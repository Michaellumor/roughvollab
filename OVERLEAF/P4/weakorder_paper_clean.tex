...
\reframe{Lift section must engage Bayer--Breneis 2023 (weak error of Markovian
approximations bounded by the L1 kernel error -- more factors, smaller weak error) and
Bayer--Breneis 2024 (second-order weak scheme on the Markovian approximation). State
exactly how this lift's noise approximation differs from the Abi Jaber--El Euch /
Bayer--Breneis construction, or drop the section. Also state what the lift was supposed
to measure: a different scheme has its own weak rate.}
