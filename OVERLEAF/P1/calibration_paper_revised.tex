...
Code and data: \url{https://github.com/Michaellumor/roughvollab}.}\\[0.4em]
\normalsize Project advisor: \textsc{Dr Sabine von H\"unerbein}\thanks{University of Salford.}}
\date{July 2026}
...
audited elsewhere~\cite{lumor_identifiability}, with a sobering conclusion: at the roughness
...
structure of the at-the-money skew. Fukasawa~\cite{fukasawa2017} constructs a rough
...
short-time skew asymptotics were subsequently sharpened in~\cite{bfghs2019,efgr2019}. On
the calibration side, El Euch, Gatheral and Rosenbaum~\cite{egr2019} introduced the rough
...
Bayer et al.~\cite{bhmst2019} studied calibration of rough models through learned pricing
maps. None of these works asks whether, given the surface one actually observes, $H$ is
identified at all; that is the question here.
