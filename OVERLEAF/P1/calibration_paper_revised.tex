...
market's crash-fear tail sits above the model at every maturity---and the longer-maturity convexity.
...
direction, $|{\rm flat}[H]|=0.118$ within a poorly-conditioned problem ($\mathrm{cond}=9.8\times
...
volatility-of-volatility (their correlation is $-0.88$ to $-0.91$), not a consequence of a truncated
...
left-tail implied volatilities sit above the model's at every tenor, and the longer-maturity smiles
